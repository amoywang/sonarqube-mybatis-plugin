...
/* xml/node/ibatis/YIsNotPropertyAvailableNode.class */
public class YIsNotPropertyAvailableNode extends BaseIbatisNode {
    ...
    public void setConfilct(String type) {
        if (type.equalsIgnoreCase(Constant.ISPROPERTYAVAILABLE)) {
