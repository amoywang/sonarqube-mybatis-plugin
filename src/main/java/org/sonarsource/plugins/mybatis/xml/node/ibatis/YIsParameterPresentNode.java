...
/* xml/node/ibatis/YIsParameterPresentNode.class */
public class YIsParameterPresentNode extends BaseIbatisNode {
    ...
    public void setConfilct(String type) {
        if (type.equalsIgnoreCase(Constant.ISNOTPARAMETERPRESENT)) {
