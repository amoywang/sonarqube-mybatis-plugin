...
/* xml/node/ibatis/YIsNotParameterPresentNode.class */
public class YIsNotParameterPresentNode extends BaseIbatisNode {
    ...
    public void setConfilct(String type) {
        if (type.equalsIgnoreCase(Constant.ISPARAMETERPRESENT)) {
