...
/* xml/node/ibatis/YIsPropertyAvailableNode.class */
public class YIsPropertyAvailableNode extends BaseIbatisNode {
    @Override
    ...
    public void setConfilct(String type) {
        if (type.equalsIgnoreCase(Constant.ISNOTPROPERTYAVAILABLE)) {
